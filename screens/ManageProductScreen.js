          ...
          <View className="p-4">
            <View className="flex flex-row justify-between items-center ">
              <View className="flex flex-row  items-center">
                <Image
                  ...
                  style={{ width: 15, height: 15 }}
                />
                <Text className="font-semibold text-loaknow-gray mr-2 text-base">
                  Casing Jatinangor
                </Text>
                <Text className="font-semibold text-loaknow-gray text-base">
                  &gt;
                </Text>
              </View>
              <View>
            ...
            <View className="flex flex-row">
              <View>
                <Image
                  className="mr-2"
                  source={require("../assets/images/manage-product-hp.png")}
              ...
              <View>
                ...
                <Text className="font-semibold text-base text-loaknow-blue">
                  Rp20.000
                </Text>
                <Text>1x</Text>
              </View>
            ...
            <View className="flex flex-row justify-between p-4">
              <View className="flex flex-row items-center justify-center gap-2">
                ...
                <View>
                  ...
                  <View className="flex flex-row">
                    <Text className=" text-loaknow-gray mr-2">
                      15 April 2024
                    </Text>
